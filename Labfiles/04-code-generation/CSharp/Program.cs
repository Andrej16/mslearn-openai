...
do
{
   ...
   if (command == "1" || command == "2")
      codeFile = File.ReadAllText("../sample-code/function/function.cs");
   else if (command == "3")
      codeFile = File.ReadAllText("../sample-code/go-fish/go-fish.cs");
   else
   {
...
async Task GetResponseFromOpenAI(string prompt)
{
   ...
   {
      Console.WriteLine("Please check your appsettings.json for missing values.");
      return;
   }
